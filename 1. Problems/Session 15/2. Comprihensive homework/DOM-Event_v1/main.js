...
let studentList = [["sv456", "Cao Minh Chau", "chau@gmail.com", "0987564123", "Thai Binh", "Female"]];
action = "create";
        ...
        tbody.innerHTML += `
                        <tr>
                            ...
                            <td>
                                ...
                                <button onclick = "deleteData('${studentList[i][0]}')">Delete</button>
                            </td>
                        </tr>`
    }
}
...
function deleteData() {
    let deleteCheck = confirm("Please make sure that you want to delete this data");
    if (deleteCheck) {
        let i = getStudentId();
